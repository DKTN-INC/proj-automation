...
def main():
    ...
    parser.add_argument('--pattern', default='*.pdf', help='File pattern for directory mode (default: *.pdf)')
    parser.add_argument('--notify-only', action='store_true', help='Send notification only, no files')

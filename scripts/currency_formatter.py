...
class CurrencyFormatter:
    ...
    def __init__(self, currency_code: str = 'GBP', locale_name: str = 'en_GB', 
                 symbol: str = '£', decimal_places: int = 2, symbol_position: str = 'before'):
        """
    ...
    def parse_amount(self, formatted_amount: str) -> Decimal:
        ...
        try:
            ...
            clean_amount = formatted_amount.replace(self.symbol, '').replace(self.currency_code, '').strip()

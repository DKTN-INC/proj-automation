...
async def post_pdf_to_discord(webhook_url: str, pdf_path: str, message: str | None = None) -> bool:
    """
...
async def send_pdf_if_webhook_configured(pdf_path: str, message: str | None = None) -> bool:
    """

...
def test_send_pdf_external_fallback_when_too_large(tmp_path):
    ...
    with patch.object(sender, "_upload_external_and_get_link", return_value="https://example.com/file.pdf") as mock_upload, \
         patch.object(sender, "_send_webhook_with_link", return_value=True) as mock_send_link:

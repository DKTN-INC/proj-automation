...
class CircuitBreakerManager:
    ...
    def get_breaker(self, name: str, config: Optional[CircuitConfig] = None) -> CircuitBreaker:
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        open_breakers = sum(1 for b in self._breakers.values() if b.stats.state == CircuitState.OPEN)
        half_open_breakers = sum(1 for b in self._breakers.values() if b.stats.state == CircuitState.HALF_OPEN)

...
class ThreadPoolManager:
    ...
    def is_healthy(self) -> bool:
        ...
        return (
            ...
            not self._executor._shutdown and
            self._active_tasks < self.max_workers * 2  # Allow some queuing
        )
...
def format_markdown_content(content: str, style: str = "default") -> str:
    ...
    if style == "compact":
        ...
        content = re.sub(r'^(#{1,6}\s)', r'\n\1', content, flags=re.MULTILINE)  # Space before headers
...
def parse_discord_messages(messages: list) -> dict:
    ...
    for msg in messages:
        ...
        # Extract emojis
        emojis = re.findall(r'<:\w+:\d+>|[\U0001F600-\U0001F64F\U0001F300-\U0001F5FF\U0001F680-\U0001F6FF\U0001F1E0-\U0001F1FF]', content)
    ...
    return {
        ...
        'avg_message_length': sum(stats['total_length'] for stats in user_stats.values()) / max(1, total_messages)
    }
